...
const WordWisePage = () => {
  ...
  return (<div className="w-full">
    <div className="carouesel p-8 relative min-h-[300px]">
      ...
      <div
          className="absolute bottom-14 left-1/2 -translate-x-1/2 z-10 flex items-center justify-center gap-2">
    ...
    <div
        className="word-input-div max-w-3xl mx-auto -mt-6 px-4 relative z-10 flex items-center justify-center w-full">
      <button className="btn btn-neutral btn-lg px-6 py-2 rounded-md"
              onClick={handleGoWordPage}>지금 시작하기!
      </button>
    </div>
