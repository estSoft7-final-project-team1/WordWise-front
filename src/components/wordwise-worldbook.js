      ...
      examples: [
        {
          ...
          explanation:
            "저녁 식사를 위해 식탁을 차려주세요. ('준비하다'의 의미로 사용)",
        },
        {
        ...
        },
        {
          ...
          explanation:
            "날짜는 다음 월요일로 정해졌다. ('정하다/결정하다'의 의미로 사용)",
        },
        {
          sentence: "I bought a new set of golf clubs.",
          explanation:
            "새로운 골프채 세트를 샀다. ('한 묶음'을 의미할 때 사용)",
        },
      ],
    },
    {
      ...
      examples: [
        {
          ...
          explanation:
            "그녀는 매일 아침 5킬로미터를 달린다. (물리적인 달리기 행위)",
        },
        {
          sentence: "My father runs a small business.",
          explanation:
            "아버지는 작은 사업체를 운영하신다. ('운영하다'의 의미로 사용)",
        },
        {
          sentence: "The program runs smoothly on my computer.",
          explanation:
            "이 프로그램은 내 컴퓨터에서 순조롭게 작동한다. ('작동하다'의 의미로 사용)",
        },
        {
          sentence: "Tears ran down her cheeks.",
          explanation:
            "눈물이 그녀의 뺨을 타고 흘러내렸다. ('흐르다'의 의미로 사용)",
        },
      ],
    },
    {
      ...
      examples: [
        ...
        },
        {
          ...
          explanation:
            "이 가방은 들기에 매우 가볍다. (형용사로서 '가벼운'의 의미로 사용)",
        },
        {
          sentence: "I prefer light colors for summer clothes.",
          explanation:
            "나는 여름 옷으로 연한 색상을 선호한다. ('연한/밝은'의 의미로 사용)",
        },
        {
          sentence: "Could you light the candle, please?",
          explanation:
            "촛불 좀 켜주시겠어요? (동사로서 '불을 붙이다'의 의미로 사용)",
        },
      ],
    },
  ]);
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-xl font-bold mb-6">가장 많이 등록된 단어</h2>
